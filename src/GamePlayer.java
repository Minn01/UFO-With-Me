...
class GamePanel extends JPanel {
    ...
    public GamePanel(GameWindow window) {
            ...
            public void actionPerformed(ActionEvent e) {
                if (gameOn) {
                    if (!collisionDetect) {
                        ...
                        // When collisions is detected the score saving process begins
                        try {
        ...
        // The mouse listener tracks the movement of the mouse
    ...
    public void shieldRegenTimer() {
        // The methods handles the part where t he shield regenerates
    ...
    public void startTransitionTimer() {
        ...
        transitionTimer = new Timer(35000, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
